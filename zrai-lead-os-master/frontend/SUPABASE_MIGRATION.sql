-- ============================================
-- ZRAI Lead OS - Frontend Database Schema
-- Run this in Supabase SQL Editor
-- ============================================

-- Migration 0000: Initial User and Chat tables
...
-- Migration 0001: Document and Suggestion tables
...
-- Migration 0002: Message and Vote tables (deprecated v1)
...
-- Migration 0005: Message_v2 and Vote_v2 tables (current)
