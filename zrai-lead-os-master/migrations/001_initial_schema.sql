-- ZRAI Lead OS - Initial Database Schema
-- Requirements: 3.8, 5.1-5.6, 6.7, 7.5, 9.3, 13.1, 14.2, 16.2, 18.1, 18.2, 20.2, 21.1-21.9, 22.4

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ==================== LEADS TABLE ====================
-- Requirements: 3.7, 3.8, 18.2, 21.1-21.9
...
-- ==================== LEAD STATE TABLE (LangGraph Checkpointer) ====================
