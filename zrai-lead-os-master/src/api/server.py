...
async def enrich_lead(
    ...
    try:
        ...
        # Convert to Lead model and create state
        lead = lead_data_to_model(lead_data)
        ...
        if request.lead_ids:
            for lead_id in request.lead_ids:
                ...
                if result_state.scoring:
                    results.append({
                        "lead_id": lead_id,
                        "score": result_state.scoring.final_score,
...
async def handle_outreach(
    ...
    try:
        ...
        outreach_data = None
        if result_state.outreach_messages:
            outreach_data = [msg.model_dump() for msg in result_state.outreach_messages]
