...
class SupabaseCheckpointer(BaseCheckpointSaver):
    ...
    def put(
        ...
        # Extract actual lead_id from thread_id (handles dry_run and replay suffixes)
        lead_id_str = thread_id.split("_")[0] if "_" in thread_id else thread_id
        ...
        data = {
            "lead_id": lead_id_str,  # Use extracted lead_id, not thread_id
    ...
    def get_tuple(self, config: Dict[str, Any]) -> Optional[CheckpointTuple]:
        ...
        # Extract lead_id from thread_id (handles dry_run and replay suffixes)
        lead_id_str = thread_id.split("_")[0] if "_" in thread_id else thread_id
        ...
        state_data = self._client.get_lead_state(lead_uuid)
        if not state_data:
            return None
        ...
        *,
        ...
        if thread_id:
            ...
            try:
                ...
                return  # Invalid UUID, yield nothing
