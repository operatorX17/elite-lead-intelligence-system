...
class LLMConfig(BaseModel):
    ...
    provider: LLMProvider = Field(default=LLMProvider.GOOGLE, description="Default LLM provider")
    model: str = Field(default="gemini-2.5-flash", description="Default model name")
