...
def node_ingest_context(state: dict) -> dict:
    ...
    return {
        ...
        "messages": history,
        "lead_data": lead_data,
        "clinic_name": lead_data.get("clinic_name", saved.get("business_name", "")),
        "owner_name": lead_data.get("owner_name", saved.get("contact_name", "")),
        "city": lead_data.get("city", saved.get("city", "")),
        "weakness_summary": lead_data.get("weakness_summary", ""),
