...
class ConversationEntities(BaseModel):
    ...
    current_reply_owner: Optional[str] = None
    decision_maker_confirmed: bool = False
    decision_maker_role: Optional[str] = None
    response_speed_status: Optional[str] = None
    follow_up_consistency: Optional[str] = None
    appointment_no_show_risk: Optional[str] = None
    goal_focus: Optional[str] = None
    requested_next_step: Optional[str] = None
    preferred_time: Optional[str] = None
    handoff_requested: bool = False
    pilot_interest: bool = False
    payment_interest: bool = False
